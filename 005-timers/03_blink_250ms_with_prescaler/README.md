## About
An LED blinks at 250ms through the configuration of Timer/Counter1

## Steps
- Read datasheets to find what registers to use.
- Reminder set pin to output: PB1 is IO9

- 03_blink_250ms_with_prescaler is the same as 02_blink_each_second_compareMatchInterrupt with one difference
    - The prescaler is set to a divisor of 256 instead of 1024
